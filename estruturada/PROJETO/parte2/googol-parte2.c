...
void divisao(int num1[], int num2[], int tamanho1, int tamanho2, char diviResto){
    int tamanhoDividendo,divisivel=1,multiplicador,tamanhoRes=0,digitosRestantes,tamanhoAux;
    int dividendo[],resultado[],resto[],aux[];
    ...
    while(divisivel){
        ...
        copiaVetor(num2,aux);
        incrementaDividendo(dividendo,qtdeDigito);
        ...
        if(maiorMenor(dividendo,aux,tamanhoDividendo,tamanho2)>=0){
            for(multiplicador=9; multiplicador>=1; multiplicador--){
                copiaVetor(num2,aux);
                if(maiorMenor(multiplicacaoSimples(aux,multiplicador),dividendo)<=0){
                    adicionaInteiro(resultado,multiplicador);
                    tamanhoRes++;
                    tamanhoAux=tamanhoVetor(aux,TAM_MAX-1);
